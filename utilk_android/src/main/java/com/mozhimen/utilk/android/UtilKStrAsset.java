...
public class UtilKStrAsset {
    ...
    public static File strAssetName2file(Context context, String strAssetName, String strFilePathNameDest, boolean isAppend, int bufferSize) throws Exception {
        if (!isAssetExists(context, strAssetName)) return null;
            ...
            return com.mozhimen.utilk.java.UtilKInputStreamFormat.inputStream2file(UtilKAssetManager.open(context, strAssetName), strAssetName2strFilePathName(strAssetName, strFilePathNameDest), isAppend, bufferSize);
    }
    ...
    public static Bitmap strAssetName2bitmapOfDecryptDisplace(Context context, String strAssetName) {
        ...
        try {
            ...
            strLogo = UtilKCryptDisplace.decrypt2bitmap(str);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return strLogo;
    ...
    public static Bitmap strAssetName2bitmap(Context context, String strAssetName) {
        try {
            if (!isAssetExists(context, strAssetName)) return null;
                ...
                return UtilKInputStreamFormat.inputStream2bitmapAny(UtilKAssetManager.open(context, strAssetName));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static String strAssetName2str(Context context, String assetFileName) throws Exception {
        if (!isAssetExists(context, assetFileName)) return null;
            ...
            return com.mozhimen.utilk.java.UtilKInputStreamFormat.inputStream2str(context.getResources().getAssets().open(assetFileName));
    }
